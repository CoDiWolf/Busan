...
<html lang="kor">
    ...
    <body>
           ...
           <section class="content-section" id="portfolio">
            ...
            <div class="container px-4 px-lg-5"> 
                ...
                <div class="row gx-0" id="gijangtour">
                 ...
                 <c:forEach items="${bukgu.content}" var="tboard" varStatus="st">
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="/freeboard/bukgu/${tboard.galContentId } ">
                            <div class="caption">
		...
		<ul class="pagination mt-3">
			<!-- 이전 -->
			<c:if test="${bukgu.first==false }">
				<li class="page-item" ><a class="page-link"
					href="bukgu?page=0">첫페이지</a></li>
			</c:if>
			<!-- 페이지 -->
			<c:forEach begin="${startPage }" end="${endPage }" var="i">
				<c:if test="${currentpage == i }">
					<li class="page-item active"><a class="page-link" href="bukgu?page=${i} }">${i}</a></li>
				</c:if>
				<c:if test="${currentpage != i }">
		 <li class="page-item"><a class="page-link" href="bukgu?page=${i-1}">${i}</a></li>
				
				</c:if>
			</c:forEach>
			<!-- 다음 -->
			<c:if test="${bukgu.last==false }">
				<li class="page-item"><a class="page-link"
					href="bukgu?page=${countpge-1 }">끝페이지</a></li>
			</c:if>
