           ...
           <section class="content-section" id="portfolio">
            ...
            <div class="container px-4 px-lg-5"> 
                ...
                <div class="content-section-heading text-center">
                 ...
                 <img class="gimg" src="/assets/img/부산 기장군.jpg" alt="..." / > 
                    <div class = gi >기장</div>
                    <h2 class="mb-5">유명 관광지</h2>
                </div>
                <div class="row gx-0" id="gijangtour">
                
                 <c:forEach items="${barr.content}" var="tboard" varStatus="st">
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="/freeboard/gijang/${tboard.galContentId  }">
                            <div class="caption">
		...
		<ul class="pagination mt-3">
			...
			<c:if test="${barr.first==false }">
				<li class="page-item" ><a class="page-link"
					href="gijang?page=0">첫페이지</a></li>
			</c:if>
			<!-- 페이지 -->
			<c:forEach begin="${startPage}" end="${endPage}" var="i">
				<c:if test="${currentpage == i }">
					<li class="page-item active"><a class="page-link" href="gijang?page=${i} }">${i}</a></li>
				</c:if>
				<c:if test="${currentpage != i }">
		 <li class="page-item"><a class="page-link" href="gijang?page=${i-1}">${i}</a></li>
			...
			<c:if test="${barr.last==false }">
				<li class="page-item"><a class="page-link"
					href="gijang?page=${countpge-1}">끝페이지</a></li>
			</c:if>
